...
def find_dots(image):
    ...
    lower_green = np.array([30, 50, 30])  # Increased the minimum saturation and value
...
while True:
    x = input("Press 'y' to capture an image or any other key to exit: ")
    if x == "y":
        ...
        if result:
            ...
            print(find_dots(image))
            print("Image saved as yo.jpg")
